"""
Django settings for projectLLM project.
...
SECRET_KEY = 'django-insecure-vsv9#we25b!)z#xb1wew*u)97d*#@zr4_+vvgl$pf^7+e*dr+m'
...
WSGI_APPLICATION = 'projectLLM.wsgi.application'
